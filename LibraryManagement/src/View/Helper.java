...
//------------------------------------------------------------------------------
    ...
    public static LocalDate getOptionalLocalDate(String enter_new_publication_year_or_press_Enter) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public static boolean getStatusOptional(String enter_new_status_or_press_Enter_to_keep_e) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
